...
func Authentications(c *context.RestContext) {
...
func NewAuthSource(c *context.RestContext) {
...
func NewAuthSourcePost(c *context.RestContext, f form.Authentication) {
	c.Data["Title"] = c.Tr("admin.auths.new")
	c.Data["PageIsAdmin"] = true
	c.Data["PageIsAdminAuthentications"] = true
...
func EditAuthSource(c *context.RestContext) {
...
func EditAuthSourcePost(c *context.RestContext, f form.Authentication) {
	c.Data["Title"] = c.Tr("admin.auths.edit")
	c.Data["PageIsAdmin"] = true
	c.Data["PageIsAdminAuthentications"] = true
...
func DeleteAuthSource(c *context.RestContext) {
	source, err := models.GetLoginSourceByID(c.ParamsInt64(":authid"))
	if err != nil {
		c.Handle(500, "GetLoginSourceByID", err)
		return
