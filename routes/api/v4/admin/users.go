...
func Users(c *context.RestContext) {
	c.Data["Title"] = c.Tr("admin.users")
	c.Data["PageIsAdmin"] = true
	c.Data["PageIsAdminUsers"] = true

	routes.RenderUserSearch(c.Context, &routes.UserSearchOptions{
...
func NewUser(c *context.RestContext) {
...
func NewUserPost(c *context.RestContext, f form.AdminCrateUser) {
	c.Data["Title"] = c.Tr("admin.users.new_account")
	c.Data["PageIsAdmin"] = true
	c.Data["PageIsAdminUsers"] = true
...
func prepareUserInfo(c *context.RestContext) *models.User {
...
func EditUser(c *context.RestContext) {
...
func EditUserPost(c *context.RestContext, f form.AdminEditUser) {
	c.Data["Title"] = c.Tr("admin.users.edit_account")
	c.Data["PageIsAdmin"] = true
	c.Data["PageIsAdminUsers"] = true
	c.Data["EnableLocalPathMigration"] = setting.Repository.EnableLocalPathMigration
...
func DeleteUser(c *context.RestContext) {
	u, err := models.GetUserByID(c.ParamsInt64(":userid"))
	if err != nil {
		c.Handle(500, "GetUserByID", err)
		return
