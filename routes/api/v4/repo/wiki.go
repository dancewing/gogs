...
func MustEnableWiki(c *context.RestContext) {
...
func renderWikiPage(c *context.RestContext, isViewPage bool) (*git.Repository, string) {
...
func Wiki(c *context.RestContext) {
...
func WikiPages(c *context.RestContext) {
...
func NewWiki(c *context.RestContext) {
...
func NewWikiPost(c *context.RestContext, f form.NewWiki) {
	c.Data["Title"] = c.Tr("repo.wiki.new_page")
	c.Data["PageIsWiki"] = true
	c.Data["RequireSimpleMDE"] = true
...
func EditWiki(c *context.RestContext) {
	c.Data["PageIsWiki"] = true
...
func EditWikiPost(c *context.RestContext, f form.NewWiki) {
	c.Data["Title"] = c.Tr("repo.wiki.new_page")
	c.Data["PageIsWiki"] = true
	c.Data["RequireSimpleMDE"] = true
...
func DeleteWikiPagePost(c *context.RestContext) {
	pageURL := c.Params(":page")
	if len(pageURL) == 0 {
		pageURL = "Home"
	}
