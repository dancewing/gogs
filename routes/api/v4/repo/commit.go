...
func RefCommits(c *context.RestContext) {
...
func renderCommits(c *context.RestContext, filename string) {
...
func Commits(c *context.RestContext) {
	renderCommits(c, "")
}

func SearchCommits(c *context.RestContext) {
	c.Data["PageIsCommits"] = true
...
func FileHistory(c *context.RestContext) {
	renderCommits(c, c.Repo.TreePath)
}

func Diff(c *context.RestContext) {
...
func RawDiff(c *context.RestContext) {
...
func CompareDiff(c *context.RestContext) {
