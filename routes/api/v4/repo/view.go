...
func renderDirectory(c *context.RestContext, treeLink string) {
...
func renderFile(c *context.RestContext, entry *git.TreeEntry, treeLink, rawLink string) {
...
func setEditorconfigIfExists(c *context.RestContext) {
...
func Home(c *context.RestContext) {
...
func RenderUserCards(c *context.RestContext, total int, getter func(page int) ([]*models.User, error), tpl string) {
...
func Watchers(c *context.RestContext) {
...
func Stars(c *context.RestContext) {
...
func Forks(c *context.RestContext) {
