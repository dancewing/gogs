...
func RetrievePipeline(c *context.RestContext) {
...
func ListPipelines(c *context.RestContext) {
...
func ViewPipeline(c *context.RestContext) {
...
func NewPipeline(c *context.RestContext) {
	c.Data["PageIsPipelineList"] = true
...
func NewPipelinePost(c *context.RestContext, form form.NewPipeline) {
...
func ListJobs(c *context.RestContext) {
...
func ViewJob(c *context.RestContext) {
	c.Data["PageIsJobList"] = true
...
func ListEnvironments(c *context.RestContext) {
...
func ViewEnvironment(c *context.RestContext) {
...
func getFakePayroad(c *context.RestContext, branch string) api.Payloader {
