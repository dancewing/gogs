...
func loadBranches(c *context.RestContext) []*Branch {
...
func Branches(c *context.RestContext) {
...
func AllBranches(c *context.RestContext) {
	c.Data["Title"] = c.Tr("repo.git_branches")
...
func DeleteBranchPost(c *context.RestContext) {
	branchName := c.Params("*")
