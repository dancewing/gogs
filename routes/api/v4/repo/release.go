...
func Releases(c *context.RestContext) {
...
func renderReleaseAttachmentSettings(c *context.RestContext) {
...
func NewRelease(c *context.RestContext) {
...
func NewReleasePost(c *context.RestContext, f form.NewRelease) {
	c.Data["Title"] = c.Tr("repo.release.new_release")
	c.Data["PageIsReleaseList"] = true
	renderReleaseAttachmentSettings(c)
...
func EditRelease(c *context.RestContext) {
...
func EditReleasePost(c *context.RestContext, f form.EditRelease) {
	c.Data["Title"] = c.Tr("repo.release.edit_release")
	c.Data["PageIsReleaseList"] = true
	c.Data["PageIsEditRelease"] = true
	renderReleaseAttachmentSettings(c)
...
func UploadReleaseAttachment(c *context.RestContext) {
	if !setting.Release.Attachment.Enabled {
		c.NotFound()
		return
	}
...
func DeleteRelease(c *context.RestContext) {
