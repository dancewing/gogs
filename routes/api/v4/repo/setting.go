...
func SettingsPost(c *context.RestContext, f form.RepoSetting) {
	c.Title("repo.settings")
	c.PageIs("SettingsOptions")
...
func SettingsCollaboration(c *context.RestContext) {
...
func SettingsCollaborationPost(c *context.RestContext) {
...
func ChangeCollaborationAccessMode(c *context.RestContext) {
...
func DeleteCollaboration(c *context.RestContext) {
...
func SettingsBranches(c *context.RestContext) {
...
func UpdateDefaultBranch(c *context.RestContext) {
...
func SettingsProtectedBranch(c *context.RestContext) {
	branch := c.Params("*")
	if !c.Repo.GitRepo.IsBranchExist(branch) {
		c.NotFound()
		return
...
func SettingsProtectedBranchPost(c *context.RestContext, f form.ProtectBranch) {
	branch := c.Params("*")
	if !c.Repo.GitRepo.IsBranchExist(branch) {
		c.NotFound()
		return
...
func SettingsGitHooks(c *context.RestContext) {
...
func SettingsGitHooksEdit(c *context.RestContext) {
	c.Data["Title"] = c.Tr("repo.settings.githooks")
	c.Data["PageIsSettingsGitHooks"] = true
...
func SettingsGitHooksEditPost(c *context.RestContext) {
	name := c.Params(":name")
	hook, err := c.Repo.GitRepo.GetHook(name)
	if err != nil {
		if err == git.ErrNotValidHook {
...
func SettingsDeployKeys(c *context.RestContext) {
...
func SettingsDeployKeysPost(c *context.RestContext, f form.AddSSHKey) {
	c.Data["Title"] = c.Tr("repo.settings.deploy_keys")
	c.Data["PageIsSettingsKeys"] = true
...
func DeleteDeployKey(c *context.RestContext) {
