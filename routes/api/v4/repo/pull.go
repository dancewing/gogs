...
func parseBaseRepository(c *context.RestContext) *models.Repository {
...
func Fork(c *context.RestContext) {
...
func ForkPost(c *context.RestContext, f form.CreateRepo) {
	c.Data["Title"] = c.Tr("new_fork")
...
func checkPullInfo(c *context.RestContext) *models.Issue {
...
func PrepareMergedViewPullInfo(c *context.RestContext, issue *models.Issue) {
...
func PrepareViewPullInfo(c *context.RestContext, issue *models.Issue) *git.PullRequestInfo {
...
func ViewPullCommits(c *context.RestContext) {
...
func ViewPullFiles(c *context.RestContext) {
	c.Data["PageIsPullList"] = true
...
func MergePullRequest(c *context.RestContext) {
	issue := checkPullInfo(c)
	if c.Written() {
		return
	}
...
func ParseCompareInfo(c *context.RestContext) (*models.User, *models.Repository, *git.Repository, *git.PullRequestInfo, string, string) {
...
func CompareAndPullRequest(c *context.RestContext) {
...
func CompareAndPullRequestPost(c *context.RestContext, f form.NewIssue) {
	c.Data["Title"] = c.Tr("repo.pulls.compare_changes")
	c.Data["PageIsComparePull"] = true
	c.Data["IsDiffCompare"] = true
	c.Data["RequireHighlightJS"] = true
...
func parseOwnerAndRepo(c *context.RestContext) (*models.User, *models.Repository) {
...
func TriggerTask(c *context.RestContext) {
