...
func Webhooks(c *context.RestContext) {
...
func getOrgRepoCtx(c *context.RestContext) (*OrgRepoCtx, error) {
...
func checkHookType(c *context.RestContext) string {
...
func WebhooksNew(c *context.RestContext) {
...
func WebHooksNewPost(c *context.RestContext, f form.NewWebhook) {
	c.Data["Title"] = c.Tr("repo.settings.add_webhook")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksNew"] = true
	c.Data["Webhook"] = models.Webhook{HookEvent: &models.HookEvent{}}
...
func SlackHooksNewPost(c *context.RestContext, f form.NewSlackHook) {
...
func DiscordHooksNewPost(c *context.RestContext, f form.NewDiscordHook) {
	c.Data["Title"] = c.Tr("repo.settings")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksNew"] = true
	c.Data["Webhook"] = models.Webhook{HookEvent: &models.HookEvent{}}
...
func DingtalkHooksNewPost(c *context.RestContext, f form.NewDingtalkHook) {
	c.Data["Title"] = c.Tr("repo.settings")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksNew"] = true
	c.Data["Webhook"] = models.Webhook{HookEvent: &models.HookEvent{}}
...
func checkWebhook(c *context.RestContext) (*OrgRepoCtx, *models.Webhook) {
...
func WebHooksEdit(c *context.RestContext) {
...
func WebHooksEditPost(c *context.RestContext, f form.NewWebhook) {
	c.Data["Title"] = c.Tr("repo.settings.update_webhook")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksEdit"] = true
...
func SlackHooksEditPost(c *context.RestContext, f form.NewSlackHook) {
	c.Data["Title"] = c.Tr("repo.settings")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksEdit"] = true
...
// FIXME: merge logic to Slack
func DiscordHooksEditPost(c *context.RestContext, f form.NewDiscordHook) {
	c.Data["Title"] = c.Tr("repo.settings")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksEdit"] = true
...
func DingtalkHooksEditPost(c *context.RestContext, f form.NewDingtalkHook) {
	c.Data["Title"] = c.Tr("repo.settings")
	c.Data["PageIsSettingsHooks"] = true
	c.Data["PageIsSettingsHooksEdit"] = true
...
func TestWebhook(c *context.RestContext) {
...
func RedeliveryWebhook(c *context.RestContext) {
...
func DeleteWebhook(c *context.RestContext) {
