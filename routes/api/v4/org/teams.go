...
func Teams(c *context.RestContext) {
...
func TeamsAction(c *context.RestContext) {
...
func TeamsRepoAction(c *context.RestContext) {
	if !c.Org.IsOwner {
		//c.Error(404) //TODO
		return
	}
...
func NewTeam(c *context.RestContext) {
...
func NewTeamPost(c *context.RestContext, f form.CreateTeam) {
	c.Data["Title"] = c.Org.Organization.FullName
	c.Data["PageIsOrgTeams"] = true
	c.Data["PageIsOrgTeamsNew"] = true
...
func TeamMembers(c *context.RestContext) {
...
func TeamRepositories(c *context.RestContext) {
	c.Data["Title"] = c.Org.Team.Name
	c.Data["PageIsOrgTeams"] = true
...
func EditTeam(c *context.RestContext) {
	c.Data["Title"] = c.Org.Organization.FullName
	c.Data["PageIsOrgTeams"] = true
...
func EditTeamPost(c *context.RestContext, f form.CreateTeam) {
	t := c.Org.Team
	c.Data["Title"] = c.Org.Organization.FullName
	c.Data["PageIsOrgTeams"] = true
	c.Data["Team"] = t
...
func DeleteTeam(c *context.RestContext) {
