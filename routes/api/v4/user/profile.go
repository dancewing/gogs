...
func GetUserByName(c *context.RestContext, name string) *models.User {
...
func GetUserByParams(c *context.RestContext) *models.User {
	return GetUserByName(c, c.Params(":username"))
}

func Profile(c *context.RestContext) {
...
func Followers(c *context.RestContext) {
	u := GetUserByParams(c)
	if c.Written() {
		return
	}
...
func Following(c *context.RestContext) {
	u := GetUserByParams(c)
	if c.Written() {
		return
	}
