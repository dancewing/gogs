...
func getDashboardContextUser(c *context.RestContext) *models.User {
	ctxUser := c.User
...
func retrieveFeeds(c *context.RestContext, ctxUser *models.User, userID int64, isProfile bool) {
...
func Dashboard(c *context.RestContext) {
...
func ShowSSHKeys(c *context.RestContext, uid int64) {
...
func showOrgProfile(c *context.RestContext) {
	c.SetParams(":org", c.Params(":username"))
	context.HandleOrgAssignment(c.Context)
	if c.Written() {
		return
	}
...
func Email2User(c *context.RestContext) {
