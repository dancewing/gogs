...
func Settings(c *context.RestContext) {
...
func SettingsPost(c *context.RestContext, f form.UpdateProfile) {
	c.Title("settings.profile")
	c.PageIs("SettingsProfile")
	c.Data["origin_name"] = c.User.Name
...
// FIXME: limit size.
func UpdateAvatarSetting(c *context.RestContext, f form.Avatar, ctxUser *models.User) error {
...
func SettingsAvatar(c *context.RestContext) {
	c.Title("settings.avatar")
	c.PageIs("SettingsAvatar")
	c.Success(SETTINGS_AVATAR)
}

func SettingsAvatarPost(c *context.RestContext, f form.Avatar) {
...
func SettingsDeleteAvatar(c *context.RestContext) {
...
func SettingsPassword(c *context.RestContext) {
	c.Title("settings.password")
	c.PageIs("SettingsPassword")
	c.Success(SETTINGS_PASSWORD)
}

func SettingsPasswordPost(c *context.RestContext, f form.ChangePassword) {
	c.Title("settings.password")
	c.PageIs("SettingsPassword")
...
func SettingsEmails(c *context.RestContext) {
...
func SettingsEmailPost(c *context.RestContext, f form.AddEmail) {
	c.Title("settings.emails")
	c.PageIs("SettingsEmails")
	...
	if setting.Service.RegisterEmailConfirm {
		mailer.SendActivateEmailMail(c.Context.Context, models.NewMailerUser(c.User), email.Email)
...
func DeleteEmail(c *context.RestContext) {
...
func SettingsSSHKeys(c *context.RestContext) {
...
func SettingsSSHKeysPost(c *context.RestContext, f form.AddSSHKey) {
	c.Title("settings.ssh_keys")
	c.PageIs("SettingsSSHKeys")
...
func DeleteSSHKey(c *context.RestContext) {
...
func SettingsSecurity(c *context.RestContext) {
...
func SettingsTwoFactorEnable(c *context.RestContext) {
...
func SettingsTwoFactorEnablePost(c *context.RestContext) {
...
func SettingsTwoFactorRecoveryCodes(c *context.RestContext) {
	if !c.User.IsEnabledTwoFactor() {
		c.NotFound()
		return
	}
...
func SettingsTwoFactorRecoveryCodesPost(c *context.RestContext) {
	if !c.User.IsEnabledTwoFactor() {
		c.NotFound()
		return
	}
...
func SettingsTwoFactorDisable(c *context.RestContext) {
	if !c.User.IsEnabledTwoFactor() {
		c.NotFound()
		return
	}
...
func SettingsRepos(c *context.RestContext) {
...
func SettingsLeaveRepo(c *context.RestContext) {
...
func SettingsOrganizations(c *context.RestContext) {
...
func SettingsLeaveOrganization(c *context.RestContext) {
...
func SettingsApplications(c *context.RestContext) {
...
func SettingsApplicationsPost(c *context.RestContext, f form.NewAccessToken) {
	c.Title("settings.applications")
	c.PageIs("SettingsApplications")
...
func SettingsDeleteApplication(c *context.RestContext) {
...
func SettingsDelete(c *context.RestContext) {
