...
func ExploreRepos(c *context.RestContext) {
...
func RenderUserSearch(c *context.RestContext, opts *UserSearchOptions) {
	page := c.QueryInt("page")
	if page <= 1 {
		page = 1
	}
...
func ExploreUsers(c *context.RestContext) {
	c.Data["Title"] = c.Tr("explore")
	c.Data["PageIsExplore"] = true
...
func ExploreOrganizations(c *context.RestContext) {
	c.Data["Title"] = c.Tr("explore")
	c.Data["PageIsExplore"] = true
...
func NotFound(c *context.RestContext) {
