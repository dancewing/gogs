...
func Services(c *context.Context) {
...
func ServicesEdit(c *context.Context) {
...
func getOrgRepoCtxForService(c *context.Context) (*OrgRepoCtx, error) {
...
func ServicesJenkinsPost(c *context.Context, edit models.JenkinsServiceConfigLoad) {
...
func ServicesPost(c *context.Context) {
	c.Data["Title"] = c.Tr("repo.settings.add_webhook")
	c.Data["PageIsSettingsServices"] = true
	c.Data["PageIsSettingsServicesEdit"] = true
